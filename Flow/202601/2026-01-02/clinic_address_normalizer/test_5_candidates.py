...
def search_and_get_details(query: str) -> list:
    ...
    try:
        ...
        for i, place in enumerate(places, 1):
            ...
            print(f"  [{i}] {display_name} ⭐{rating} ({user_rating_count}件)")
...
# CSV出力
if all_results:
    output_file = "test_5_candidates_output.csv"
    with open(output_file, 'w', encoding='utf-8', newline='') as f:
        fieldnames = ["順位", "医院名", "住所", "郵便番号", "URL", "評価", "口コミ件数"]
