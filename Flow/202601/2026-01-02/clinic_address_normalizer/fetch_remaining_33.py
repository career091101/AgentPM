#!/usr/bin/env python3
"""
残り33都府県の子供向け歯科医院データ取得

既に取得済み：東京都、大阪府、愛知県、福岡県、熊本県、愛媛県、鹿児島県、佐賀県、長崎県、大分県、高知県、宮崎県（12都府県）
残り：33都府県
"""
...
output_file = f"pediatric_dental_remaining33_{timestamp}.csv"
...
if filtered_results:
    ...
    if filtered_results:
        ...
        print(f"\n都道府県別内訳（上位15）:")
        for pref, count in prefecture_counts.most_common(15):
