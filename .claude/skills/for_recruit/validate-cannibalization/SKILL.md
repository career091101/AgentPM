...
Recruit_Product_Research 19件の撤退事例のうち、**26%（5件）がカニバリゼーションを主要失敗要因**としており、企業内新規事業特有の最大リスクである。
...
reference:
  success_cases:
    - product: "Airレジ"
      ...
      evidence_source: "@Recruit_Product_Research/official_Airレジ_v3.md"
    ...
    - product: "Airペイ"
      ...
      evidence_source: "@Recruit_Product_Research/official_Airペイ_v3.md"
    ...
    - product: "Geppo"
      ...
      evidence_source: "@Recruit_Product_Research/official_Geppo_v3.md"
  ...
  failure_cases:
    - product: "スタディサプリ個別指導塾オンライン中学講座"
      ...
      evidence_source: "@Recruit_Product_Research/withdrawn_スタディサプリ個別指導塾オンライン中学講座_v3.md"
    ...
    - product: "CODE.SCORE"
      ...
      evidence_source: "@Recruit_Product_Research/withdrawn_CODE.SCORE_v3.md"
    ...
    - product: "リクナビHRTech評価管理"
      ...
      evidence_source: "@Recruit_Product_Research/withdrawn_リクナビHRTech評価管理_v3.md"

data_sources:
  primary:
    - source: "Recruit_Product_Research 統合分析レポート"
      path: "@Recruit_Product_Research/analysis/integrated_analysis_report.md"
      key_findings:
    ...
    - source: "Airレジ成功事例"
      path: "@Recruit_Product_Research/official_Airレジ_v3.md"
      key_findings:
    ...
    - source: "Geppo成功事例"
      path: "@Recruit_Product_Research/official_Geppo_v3.md"
      key_findings:
    ...
    - source: "スタサプ個別指導撤退事例"
      path: "@Recruit_Product_Research/withdrawn_スタディサプリ個別指導塾オンライン中学講座_v3.md"
      key_findings:
    ...
    - source: "CODE.SCORE撤退事例"
      path: "@Recruit_Product_Research/withdrawn_CODE.SCORE_v3.md"
      key_findings:
...
- 成功事例参照: @Recruit_Product_Research/analysis/integrated_analysis_report.md
...
**データソース統合**:
- Recruit_Product_Research 31製品データを横断分析
...
**必要情報**: 新規事業概要、既存事業リスト、Recruit_Product_Research参照
...
### v1.0.0 (2026-01-02)
- 初版リリース
- Recruit_Product_Research 31製品データ統合
- 5次元カニバリゼーション評価実装
- 成功3事例、失敗5事例の詳細分析
- Ring 1-3への影響評価
