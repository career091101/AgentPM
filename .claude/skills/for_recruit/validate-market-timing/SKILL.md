...
Recruit_Product_Research 19件の撤退事例のうち、**4件（21%）が市場タイミング誤りを主要失敗要因**としています。
...
**ファイルパス**:
- `@/Users/yuichi/AIPM/aipm_v0/Stock/programs/創業支援・新規事業開発（AIエージェント）/projects/Founder_Agent_ForRecruit/Recruit_Product_Research/analysis/research_notes_v3/official_Airレジ_v3.md`
- `@/Users/yuichi/AIPM/aipm_v0/Stock/programs/創業支援・新規事業開発（AIエージェント）/projects/Founder_Agent_ForRecruit/Recruit_Product_Research/analysis/research_notes_v3/official_スタディサプリ_v3.md`
...
**ファイルパス**:
- `@/Users/yuichi/AIPM/aipm_v0/Stock/programs/創業支援・新規事業開発（AIエージェント）/projects/Founder_Agent_ForRecruit/Recruit_Product_Research/analysis/research_notes_v3/withdrawn_エリクラ_v3.md`
...
1. Recruit_Product_Research integrated_analysis_report.md - 撤退理由分析
