...
## Description
ForGenAI Edition: validate-cannibalization スキル実行

## Target Domain
生成AI特化版

## Execution
スキル実行: /Users/yuichi/AIPM/aipm_v0/.claude/skills/for_genai/validate-cannibalization/SKILL.md
...
## Expected Output
validate-cannibalization 実行結果レポート
