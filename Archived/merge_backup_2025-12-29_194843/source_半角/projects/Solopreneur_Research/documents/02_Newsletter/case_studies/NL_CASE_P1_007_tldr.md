...
# 基本情報
newsletter_name: "TLDR Newsletter"
founder_name: "Dan Ni"
founder_twitter: "@tlaboratory"
platform: "独自"
language: "en"
niche: "tech"
...
subscribers:
  ...
  growth_rate_monthly: "4.8%"
  engagement_rate: "45%"

metrics:
  engagement_rate: 50.0
  growth_rate_monthly: 4.8
  revenue_per_subscriber: 1.03
  leverage_ratio: 327.3
  buzz_score_avg: 70.0
  open_rate: 45.0
  click_rate: 5.0
  churn_rate: null
...
related:
  app_cases: []
  sns_cases: []
  strategies: ["NL_STRATEGY_003", "NL_STRATEGY_016", "NL_STRATEGY_025"]
...
quality:
  ...
  total_score: 25
  tier: "S"
  notes: "7M購読者、$7.2M ARR、16版展開の超大規模事例。Quora/Reddit広告、Newsletter Swaps、OAuth導入によるCVR 5倍化など具体的施策が豊富。複数版展開による収益最大化モデルの詳細が秀逸"
---
...
gantt
    ...
    dateFormat  YYYY-MM
    section 成長フェーズ
    0→1,000人（1ヶ月）      :2018-08, 2018-09
    1K→130,000人（20ヶ月）   :2018-09, 2020-04
    130K→1,000,000人        :2020-04, 2022-12
    複数版展開→7,000,000人   :2022-12, 2024-12
```
