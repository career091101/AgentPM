...
# 基本情報
newsletter_name: "The Generalist"
founder_name: "Mario Gabriele"
founder_twitter: "@mariogabriele"
platform: "substack"
language: "en"
niche: "business"
website: "https://www.generalist.com/"
...
subscribers:
  ...
  growth_rate_monthly: "4.5%"
  engagement_rate: "45%"

metrics:
  engagement_rate: 53.0
  growth_rate_monthly: 4.5
  revenue_per_subscriber: 3.82
  leverage_ratio: 120.0
  buzz_score_avg: 85.0
  open_rate: 45.0
  click_rate: 8.0
  churn_rate: null
...
related:
  app_cases: []
  sns_cases: []
  strategies: ["NL_STRATEGY_002", "NL_STRATEGY_008"]
...
quality:
  ...
  total_score: 24
  tier: "S"
  notes: "157K購読者、$600K ARR、1記事50-60時間投下の徹底的品質重視。Multiplayer Pieces、S-1 Clubなど独自手法。ペイウォール→スポンサーへの大胆な転換。NFT実験($59K)など先進的施策"
---
...
```mermaid
gantt
    title The Generalist 成長タイムライン
    dateFormat  YYYY-MM
    section 成長フェーズ
    0→5,000人（1年目）      :2019-08, 2020-08
    5K→41,000人（2年目）     :2020-08, 2021-08
    41K→100,000人           :2021-08, 2023-01
    100K→157,000人          :2023-01, 2025-01
```
...
```mermaid
flowchart LR
    A[無料ニュースレター 157K] -->|コンテンツ価値| B[スポンサー収益]
    A -->|コミュニティ| C[有料メンバー $499/年]
    C -->|特典| D[Circle コミュニティ]
    C -->|特典| E[月次マッチング通話]
    C -->|特典| F[投資機会]
```
