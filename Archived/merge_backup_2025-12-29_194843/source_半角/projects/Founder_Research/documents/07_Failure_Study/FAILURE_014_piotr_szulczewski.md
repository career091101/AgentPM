...
validation_data:
  cpf:
    interview_count: 40  # 推定: 失敗原因分析より、['ecommerce', 'marketplace', 'founders-fund', 'ggv-capital', 'formation-8', 'ipo-failure', 'quality-issues', 'counterfeit', 'unit-economics']業界の最低限実施数
