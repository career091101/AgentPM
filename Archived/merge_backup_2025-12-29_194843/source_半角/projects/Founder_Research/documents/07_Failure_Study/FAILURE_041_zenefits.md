...
validation_data:
  cpf:
    interview_count: 20  # 推定: 失敗原因分析より、['insurtech', 'regulatory_failure', 'compliance', 'benchmark_capital', 'sequoia_capital', 'billion_dollar_fraud', 'ceo_resignation']業界の最低限実施数
