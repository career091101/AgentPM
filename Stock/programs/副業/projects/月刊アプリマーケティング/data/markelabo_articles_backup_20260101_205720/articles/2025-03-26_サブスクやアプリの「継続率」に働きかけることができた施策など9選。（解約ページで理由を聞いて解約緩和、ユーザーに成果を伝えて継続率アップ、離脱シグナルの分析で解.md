![見出し画像](../images/2025-03-26_サブスクやアプリの「継続率」に働きかけることができた施策など9選。（解約ページで理由を聞いて解約緩和、ユーザーに成果を伝えて継続率アップ、離脱シグナルの分析で解/001.png)  

# サブスクやアプリの「継続率」に働きかけることができた施策など9選。（解約ページで理由を聞いて解約緩和、ユーザーに成果を伝えて継続率アップ、離脱シグナルの分析で解約率70％減など）
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fn35546a38846b)

   

24

[![](../images/2025-03-26_サブスクやアプリの「継続率」に働きかけることができた施策など9選。（解約ページで理由を聞いて解約緩和、ユーザーに成果を伝えて継続率アップ、離脱シグナルの分析で解/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
