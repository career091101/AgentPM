![見出し画像](../images/2025-09-30_ARR約1.5億円を超えるカップル系アプリが「レビュー獲得率」を2倍に伸ばした方法、セールス系AIプロダクトが「社内バイラル」を起こしてキーマンへの到達率を高め/001.png)  

# ARR約1.5億円を超えるカップル系アプリが「レビュー獲得率」を2倍に伸ばした方法、セールス系AIプロダクトが「社内バイラル」を起こしてキーマンへの到達率を高めた施策など、アプリやプロダクトのまとめ（9月）
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fn1b076c4e9df7)

   

7

[![](../images/2025-09-30_ARR約1.5億円を超えるカップル系アプリが「レビュー獲得率」を2倍に伸ばした方法、セールス系AIプロダクトが「社内バイラル」を起こしてキーマンへの到達率を高め/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
