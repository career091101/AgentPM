![見出し画像](../images/2025-03-30_フリマアプリに「AIによる出品改善」の機能で1ユーザーあたりの売上向上、ホテル予約アプリで「検索フィルター」をかけるAI機能がCVRに貢献など、生成AIなど活用/001.png)  

# フリマアプリに「AIによる出品改善」の機能で1ユーザーあたりの売上向上、ホテル予約アプリで「検索フィルター」をかけるAI機能がCVRに貢献など、生成AIなど活用した10事例まとめ。
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fn5a798f218cfb)

   

17

[![](../images/2025-03-30_フリマアプリに「AIによる出品改善」の機能で1ユーザーあたりの売上向上、ホテル予約アプリで「検索フィルター」をかけるAI機能がCVRに貢献など、生成AIなど活用/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
