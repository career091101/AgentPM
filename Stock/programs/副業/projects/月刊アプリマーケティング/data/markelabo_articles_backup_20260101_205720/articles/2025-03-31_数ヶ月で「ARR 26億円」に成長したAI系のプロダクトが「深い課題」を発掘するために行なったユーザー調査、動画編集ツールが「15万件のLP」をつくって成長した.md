![見出し画像](../images/2025-03-31_数ヶ月で「ARR 26億円」に成長したAI系のプロダクトが「深い課題」を発掘するために行なったユーザー調査、動画編集ツールが「15万件のLP」をつくって成長した/001.png)  

# 数ヶ月で「ARR 26億円」に成長したAI系のプロダクトが「深い課題」を発掘するために行なったユーザー調査、動画編集ツールが「15万件のLP」をつくって成長した話など、アプリやプロダクトのまとめ（3月）
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fn39d9e4138827)

   

20

[![](../images/2025-03-31_数ヶ月で「ARR 26億円」に成長したAI系のプロダクトが「深い課題」を発掘するために行なったユーザー調査、動画編集ツールが「15万件のLP」をつくって成長した/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
