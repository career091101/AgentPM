![見出し画像](../images/2025-04-30_ARR15億円に成長した「AIプロフ写真」を作れるサイトが「お金が払われやすい用途」を検証した方法、禁煙アプリが「200ドル」でサブスクCVRを爆発的に高めた方/001.png)  

# ARR15億円に成長した「AIプロフ写真」を作れるサイトが「お金が払われやすい用途」を検証した方法、禁煙アプリが「200ドル」でサブスクCVRを爆発的に高めた方法など、アプリやプロダクトのまとめ（4月）
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fn2524504a57e5)

   

16

[![](../images/2025-04-30_ARR15億円に成長した「AIプロフ写真」を作れるサイトが「お金が払われやすい用途」を検証した方法、禁煙アプリが「200ドル」でサブスクCVRを爆発的に高めた方/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
