![見出し画像](../images/2025-05-12_フォントを読みやすくしたら「予約CVR」が上がった、売り切れたホテルを表示したら「予約CVR」が伸びた理由、年間2.5万件の検証をする「Booking.com」/001.png)  

# フォントを読みやすくしたら「予約CVR」が上がった、売り切れたホテルを表示したら「予約CVR」が伸びた理由、年間2.5万件の検証をする「Booking.com」に学ぶ過去のABテスト10の成功事例まとめ。
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fncef022ec70c1)

   

31

[![](../images/2025-05-12_フォントを読みやすくしたら「予約CVR」が上がった、売り切れたホテルを表示したら「予約CVR」が伸びた理由、年間2.5万件の検証をする「Booking.com」/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
