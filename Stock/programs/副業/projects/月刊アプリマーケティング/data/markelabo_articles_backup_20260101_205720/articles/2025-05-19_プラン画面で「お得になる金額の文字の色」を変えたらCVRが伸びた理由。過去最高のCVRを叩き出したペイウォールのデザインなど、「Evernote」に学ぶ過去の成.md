![見出し画像](../images/2025-05-19_プラン画面で「お得になる金額の文字の色」を変えたらCVRが伸びた理由。過去最高のCVRを叩き出したペイウォールのデザインなど、「Evernote」に学ぶ過去の成/001.png)  

# プラン画面で「お得になる金額の文字の色」を変えたらCVRが伸びた理由。過去最高のCVRを叩き出したペイウォールのデザインなど、「Evernote」に学ぶ過去の成功施策。
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fnbc10ed51b819)

   

17

[![](../images/2025-05-19_プラン画面で「お得になる金額の文字の色」を変えたらCVRが伸びた理由。過去最高のCVRを叩き出したペイウォールのデザインなど、「Evernote」に学ぶ過去の成/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
