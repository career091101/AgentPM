![見出し画像](../images/2025-04-29_App Storeの「AIレビュー要約」で優先されやすいレビューの特徴、自社っぽいテイストを学習させた「AI画像生成ツール」で制作にかかる時間を1_10にした事/001.png)  

# App Storeの「AIレビュー要約」で優先されやすいレビューの特徴、自社っぽいテイストを学習させた「AI画像生成ツール」で制作にかかる時間を1/10にした事例など、生成AIなど活用した10事例まとめ。
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fn5126b01a79c2)

   

17

[![](../images/2025-04-29_App Storeの「AIレビュー要約」で優先されやすいレビューの特徴、自社っぽいテイストを学習させた「AI画像生成ツール」で制作にかかる時間を1_10にした事/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
