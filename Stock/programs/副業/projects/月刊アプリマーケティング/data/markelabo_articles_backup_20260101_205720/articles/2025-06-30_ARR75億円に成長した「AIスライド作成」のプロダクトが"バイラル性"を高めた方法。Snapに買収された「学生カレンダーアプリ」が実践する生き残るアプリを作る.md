![見出し画像](../images/2025-06-30_ARR75億円に成長した「AIスライド作成」のプロダクトが"バイラル性"を高めた方法。Snapに買収された「学生カレンダーアプリ」が実践する生き残るアプリを作る/001.png)  

# ARR75億円に成長した「AIスライド作成」のプロダクトが"バイラル性"を高めた方法。Snapに買収された「学生カレンダーアプリ」が実践する生き残るアプリを作るコツなど、成長プロダクトやAI活用事例まとめ。(6月)
...
[ログイン](https://note.com/cd/login?redirect_to=https%3A%2F%2Fmarkelabo.com%2Fn%2Fn63e5d588966d)

   

5

[![](../images/2025-06-30_ARR75億円に成長した「AIスライド作成」のプロダクトが"バイラル性"を高めた方法。Snapに買収された「学生カレンダーアプリ」が実践する生き残るアプリを作る/004.png)](https://few-robin-203.notion.site/cf34bb8450a64da89ce3711f3fc9a9d8)
