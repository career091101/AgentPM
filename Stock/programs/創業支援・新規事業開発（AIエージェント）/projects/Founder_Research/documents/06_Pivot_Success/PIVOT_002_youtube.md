...
validation_data:
  cpf:
    interview_count: 20  # 推定: ピボット前後の顧客調査を合算、['pivot', 'video-sharing', 'PayPal-Mafia', 'dating-to-platform', 'Google-acquisition', 'viral-growth']業界標準
    problem_commonality: 50  # 推定: ['pivot', 'video-sharing', 'PayPal-Mafia', 'dating-to-platform', 'Google-acquisition', 'viral-growth']業界標準値、市場調査データ不足
    wtp_confirmed: false
    urgency_score: 8
