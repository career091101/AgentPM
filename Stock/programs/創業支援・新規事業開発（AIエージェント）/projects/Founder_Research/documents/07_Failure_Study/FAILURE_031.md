...
validation_data:
  cpf:
    interview_count: 50  # 推定: 失敗原因分析より、['social_media', 'privacy_regulation', 'market_misalignment', 'founder_conflict', 'regulatory_pressure', 'declining_growth', 'product_pivot']業界の最低限実施数
