...
subscribers:
  total: 1100000
  paid: 19000
  paid_conversion_rate: 1.7

metrics:
  engagement_rate: 53.0
  growth_rate_monthly: 6.2
  revenue_per_subscriber: 3.64
  leverage_ratio: 250.0
  buzz_score_avg: 85.0
  open_rate: 45.0
  click_rate: 8.0
  churn_rate: null
...
related:
  app_cases: []
  sns_cases: []
  strategies: ["NL_STRATEGY_007", "NL_STRATEGY_014", "NL_STRATEGY_022"]
...
gantt
    ...
    dateFormat  YYYY-MM
    section 成長フェーズ
    0→13,000人（有料開始時）   :2019-06, 2020-04
    13K→45K人                  :2020-04, 2020-12
    45K→100K人                 :2020-12, 2022-04
    100K→250K人（推薦機能）    :2022-04, 2022-10
    250K→1,100K人              :2022-10, 2025-01
```
...
```mermaid
flowchart LR
    A[無料購読者 100万+] -->|コンテンツ価値| B[エンゲージメント向上]
    B -->|週1プレミアム記事| C[有料転換 1.7%]
    C -->|Slackコミュニティ| D[リテンション強化]

    A -->|ポッドキャスト| E[広告収益 $500K+]
    C -->|Job Board| F[手数料収益 $500K+]
    C -->|Maven講座| G[受講料 $200K+]
```
...
```mermaid
flowchart TD
    A[高品質なベンチマーク記事] -->|シェアされる| B[新規購読者獲得]
    B -->|Substack推薦で紹介| C[更なる新規獲得]
    C -->|有料転換| D[収益増加]
    D -->|リサーチに投資| A
    B -->|コミュニティ参加| E[Slackエンゲージメント]
    E -->|口コミ| B
```
