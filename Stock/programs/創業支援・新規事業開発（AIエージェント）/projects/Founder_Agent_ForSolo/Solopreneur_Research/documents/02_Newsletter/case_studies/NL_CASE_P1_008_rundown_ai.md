...
# 基本情報
newsletter_name: "The Rundown AI"
founder_name: "Rowan Cheung"
founder_twitter: "@rowancheung"
platform: "beehiiv"
language: "en"
niche: "ai"
...
metrics:
  engagement_rate: 49.3
  growth_rate_monthly: 12.5
  revenue_per_subscriber: 4.2
  leverage_ratio: 200.0
  buzz_score_avg: 88.0
  open_rate: 46.5
  click_rate: 2.8
  churn_rate: null
...
related:
  app_cases: []
  sns_cases: []
  strategies: ["NL_STRATEGY_005", "NL_STRATEGY_022"]
...
quality:
  ...
  total_score: 25
  tier: "S"
  notes: "2M購読者、$8.4M ARR、ChatGPT波の完璧なタイミング捕捉。Twitter→NLフライホイール、AI University($999/年)、beehiiv活用など多角的収益化モデル。Forbes 30 Under 30選出の権威性"
---
...
```mermaid
gantt
    title The Rundown AI 成長タイムライン
    dateFormat  YYYY-MM
    section 成長フェーズ
    0→55,000人（4ヶ月）      :2023-01, 2023-04
    55K→250,000人            :2023-04, 2023-06
    250K→500,000人           :2023-06, 2023-12
    500K→868,000人（87.8%増）:2024-01, 2024-12
    868K→2,000,000人         :2024-12, 2025-01
```
...
```mermaid
flowchart LR
    A[無料購読者 2M+] -->|コンテンツ価値| B[エンゲージメント向上]
    B -->|スポンサー| C[広告収益 $3-5M+]
    B -->|アップセル| D[AI University $3-6M]
    B -->|ツール紹介| E[Supertools 広告/アフィ]
    B -->|求人| F[The Rundown Jobs]
```
