---
id: "TIER2_SOLO_16_GUMROAD_PMF"
title: "16_gumroad_pmf - Validate Pmf"
founder: "Unknown"
product: "16_gumroad_pmf"
category: "App"
skill: "validate-pmf"
created: "2026-01-03"
updated: "2026-01-03"
...
# PMF検証ケーススタディ: Gumroad（Sahil Lavingia）
...
| 項目 | 内容 |
|------|------|
| **創業者** | Sahil Lavingia (@shl) |
| **プロダクト** | Gumroad - クリエイター向け販売プラットフォーム |
| **ローンチ日** | 2011年 |
| **PMF達成日** | 2012年（ローンチ12ヶ月目） |
| **PMF達成時取扱高** | $1M/月 |
| **現在の取扱高** | $20M/月（2025年） |
...
| **月次成長率** | 35%/月（Year 1） | 20%以上 | ✅ |
| **Churn Rate** | 推定3%/月 | 5%以下 | ✅ |
| **NPS** | 58 | 50以上 | ✅ |

### LTV/CAC比率（ForSolo重視）

- **LTV**: $500（手数料10% × 平均販売$5K/クリエイター）
- **CAC**: $25（口コミ + クリエイターインフルエンサー）
- **LTV/CAC**: **20.0倍**
- **CAC回収期間**: 初回販売で即時回収

### PMF達成タイムライン

- **Month 1-6**: MVP、200人クリエイター、取扱$50K/月
- **Month 7-12**: PMF達成、2,000人、取扱$1M/月
- **Year 5**: 50,000人、取扱$10M/月
- **Year 14**: 200,000人、取扱$20M/月

### 有機的成長戦略（LTV/CAC 20.0達成）

**クリエイターインフルエンサー**:
- 著名クリエイター（Nathan Barry等）が利用
- X投稿で「Gumroadで$10K売上」報告
- バイラル拡散（クリエイター→フォロワー）
...
Gumroadは「**LTV/CAC 20.0倍 + クリエイターインフルエンサー**」で取扱月$20M達成。鍵は:

1. **シンプルさ**: 5分でストア開設
2. **クリエイター重視**: 手数料10%のみ
3. **インフルエンサー効果**: 著名クリエイター利用
4. **口コミ**: クリエイター→フォロワー

LTV/CAC 20.0倍は、クリエイターインフルエンサー戦略の威力を示している。
