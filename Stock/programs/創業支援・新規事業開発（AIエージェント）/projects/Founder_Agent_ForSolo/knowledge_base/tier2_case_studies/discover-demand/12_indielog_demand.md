...
base_case_id: "APP_005"
title: "Brock Anderson - IndieLog (需要発見パターン)"
revenue:
  mrr_usd: 3000
  note: "IndieHacker自己管理により需要を発見"
main_product:
  name: "IndieLog"
  category: "IndieHacker Tracker"
tags:
  demand_discovery: ["IndieHackers, Twitter"]
...
# Tier 2 Case Study: Brock Anderson - IndieLog

**Tier 2専用フォーカス**: discover-demand スキル用ケーススタディ
**ニーズ発見手法**: IndieHacker自己管理

---

## 1. 概要

**発見チャネル**: IndieHackers, Twitter
**4Uスコア**: 8/12点
...
### 課題発見
- **チャネル**: IndieHackers, Twitter
- **発見手法**: IndieHacker自己管理
...
### 支払い意思検証
- **価格帯**: 類似サービスから推定
- **市場規模**: IndieHacker Tracker市場で十分な規模
...
Brock Andersonの需要発見手法は、IndieHacker自己管理により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
