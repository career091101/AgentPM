...
base_case_id: "APP_015"
title: "Alex West - Cyberleads (需要発見パターン)"
revenue:
  mrr_usd: 15000
  note: "B2Bリード獲得課題により需要を発見"
main_product:
  name: "Cyberleads"
  category: "B2B Lead Gen"
tags:
  demand_discovery: ["LinkedIn, B2B Communities"]
...
**発見チャネル**: LinkedIn, B2B Communities
**4Uスコア**: 9/12点
...
Alex Westの需要発見手法は、B2Bリード獲得課題により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
