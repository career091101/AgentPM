...
title: "Marko Kraemer - xMagic (需要発見パターン)"
revenue:
  mrr_usd: 8000
  note: "Macスクリーンショット不満により需要を発見"
main_product:
  name: "xMagic"
  category: "Mac Screenshot"
tags:
  demand_discovery: ["Product Hunt, Twitter"]
...
# Tier 2 Case Study: Marko Kraemer - xMagic

**Tier 2専用フォーカス**: discover-demand スキル用ケーススタディ
**ニーズ発見手法**: Macスクリーンショット不満

---

## 1. 概要

**発見チャネル**: Product Hunt, Twitter
**4Uスコア**: 8/12点
...
Marko Kraemerの需要発見手法は、Macスクリーンショット不満により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
