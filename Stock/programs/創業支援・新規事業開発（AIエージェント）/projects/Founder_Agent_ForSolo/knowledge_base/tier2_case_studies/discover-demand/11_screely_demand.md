...
base_case_id: "APP_026"
title: "Ping - Screely (需要発見パターン)"
revenue:
  mrr_usd: 5000
  note: "スクリーンショット美化ニーズにより需要を発見"
main_product:
  name: "Screely"
  category: "Screenshot Mockup"
tags:
...
# Tier 2 Case Study: Ping - Screely

**Tier 2専用フォーカス**: discover-demand スキル用ケーススタディ
**ニーズ発見手法**: スクリーンショット美化ニーズ
...
### 支払い意思検証
- **価格帯**: 類似サービスから推定
- **市場規模**: Screenshot Mockup市場で十分な規模
...
Pingの需要発見手法は、スクリーンショット美化ニーズにより市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
