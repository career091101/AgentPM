...
base_case_id: "APP_040"
title: "Greg Isenberg - Late Checkout (需要発見パターン)"
revenue:
  mrr_usd: 20000
  note: "コミュニティ需要により需要を発見"
main_product:
  name: "Late Checkout"
  category: "Community Platform"
tags:
  demand_discovery: ["Twitter, Communities"]
...
# Tier 2 Case Study: Greg Isenberg - Late Checkout
...
### 支払い意思検証
- **価格帯**: 類似サービスから推定
- **市場規模**: Community Platform市場で十分な規模
...
Greg Isenbergの需要発見手法は、コミュニティ需要により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
