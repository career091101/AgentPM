...
base_case_id: "APP_010"
title: "Nico Jeannen - LeadDelta (需要発見パターン)"
revenue:
  mrr_usd: 25000
  note: "LinkedIn人脈管理課題により需要を発見"
main_product:
  name: "LeadDelta"
  category: "LinkedIn CRM"
tags:
  demand_discovery: ["LinkedIn, Product Hunt"]
...
# Tier 2 Case Study: Nico Jeannen - LeadDelta

**Tier 2専用フォーカス**: discover-demand スキル用ケーススタディ
**ニーズ発見手法**: LinkedIn人脈管理課題

---

## 1. 概要

**発見チャネル**: LinkedIn, Product Hunt
**4Uスコア**: 9/12点
...
Nico Jeannenの需要発見手法は、LinkedIn人脈管理課題により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
