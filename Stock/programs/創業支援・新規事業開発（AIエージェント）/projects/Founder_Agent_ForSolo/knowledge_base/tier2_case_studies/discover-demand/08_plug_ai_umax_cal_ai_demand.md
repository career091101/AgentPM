...
base_case_id: "APP_024"
title: "Blake Anderson - Plug AI/Umax/Cal AI (需要発見パターン)"
revenue:
  mrr_usd: 1600000
  note: "TikTokバイラル+非エンジニアChatGPT開発により需要を発見"
main_product:
  name: "Plug AI/Umax/Cal AI"
  category: "AI Apps"
tags:
  demand_discovery: ["TikTok, Instagram"]
...
# Tier 2 Case Study: Blake Anderson - Plug AI/Umax/Cal AI

**Tier 2専用フォーカス**: discover-demand スキル用ケーススタディ
**ニーズ発見手法**: TikTokバイラル+非エンジニアChatGPT開発

---

## 1. 概要

**発見チャネル**: TikTok, Instagram
**4Uスコア**: 11/12点
...
### 課題発見
- **チャネル**: TikTok, Instagram
- **発見手法**: TikTokバイラル+非エンジニアChatGPT開発
...
Blake Andersonの需要発見手法は、TikTokバイラル+非エンジニアChatGPT開発により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
