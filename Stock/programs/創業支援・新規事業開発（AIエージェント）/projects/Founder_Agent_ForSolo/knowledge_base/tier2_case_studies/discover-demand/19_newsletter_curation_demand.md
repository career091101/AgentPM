...
title: "Umatan - Newsletter Curation (需要発見パターン)"
revenue:
  mrr_usd: 5000
  note: "情報キュレーション需要により需要を発見"
main_product:
  name: "Newsletter Curation"
  category: "Newsletter"
tags:
  demand_discovery: ["Twitter, Substack"]
...
# Tier 2 Case Study: Umatan - Newsletter Curation
...
Umatanの需要発見手法は、情報キュレーション需要により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
