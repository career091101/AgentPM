...
base_case_id: "APP_020"
title: "Wesley Tian - Refermatic (需要発見パターン)"
revenue:
  mrr_usd: 7000
  note: "紹介プログラム自動化により需要を発見"
main_product:
  name: "Refermatic"
  category: "Referral Software"
tags:
  demand_discovery: ["SaaS Communities"]
...
# Tier 2 Case Study: Wesley Tian - Refermatic
...
### 支払い意思検証
- **価格帯**: 類似サービスから推定
- **市場規模**: Referral Software市場で十分な規模
...
Wesley Tianの需要発見手法は、紹介プログラム自動化により市場の隙間を発見した好例。日本市場でも同様のアプローチで再現可能。
