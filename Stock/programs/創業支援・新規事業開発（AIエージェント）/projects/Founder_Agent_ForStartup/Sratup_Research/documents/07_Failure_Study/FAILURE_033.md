...
validation_data:
  cpf:
    interview_count: 20  # 推定: 失敗原因分析より、['online_education', 'mooc', 'verification_failure', 'course_completion_rate', 'unit_economics_failure', 'scaling_problem', 'andrew_ng', 'stanford']業界の最低限実施数
