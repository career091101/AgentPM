...
# 基本情報
newsletter_name: "Ben's Bites"
founder_name: "Ben Tossell"
founder_twitter: "@bentossell"
platform: "beehiiv"
language: "en"
niche: "ai"
...
# 購読者データ
subscribers_total: 148000
subscribers_paid: 2200
...
```mermaid
gantt
    title Ben's Bites 成長タイムライン
    dateFormat  YYYY-MM
    section 成長フェーズ
    0→700人（1週間）       :2022-10, 2022-10
    700→10,000人（6週間）   :2022-10, 2022-11
    10K→110,000人（13ヶ月）  :2022-11, 2023-11
    110K→148,000人          :2023-11, 2024-12
```
...
```mermaid
flowchart LR
    A[無料ニュースレター 148K] -->|コンテンツ価値| B[スポンサー収益]
    A -->|Pro転換| C[有料購読 $80-250/年]
    A -->|コミュニティ| D[Discord 3,700+]

    C -->|教育| E[コース・チュートリアル 400+]

    A -->|投資案件発掘| F[Ben's Bites Fund]
```
