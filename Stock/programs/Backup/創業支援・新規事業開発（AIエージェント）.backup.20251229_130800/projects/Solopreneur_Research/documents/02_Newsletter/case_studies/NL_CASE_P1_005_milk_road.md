...
founder_name: "Shaan Puri & Ben Levy"
founder_twitter: "@shaanvp"
platform: "beehiiv"
language: "en"
niche: "crypto"
website: "https://milkroad.com/"
...
japan_market_score:
  ...
  target_audience_exists: 2

# クロスリファレンス
related:
  app_cases: []
  sns_cases: []
  strategies: ["NL_STRATEGY_003", "NL_STRATEGY_014", "NL_STRATEGY_019"]
---
...
```mermaid
gantt
    title Milk Road 成長タイムライン
    dateFormat  YYYY-MM
    section 成長フェーズ
    0→16,000人（3週間）    :2022-02, 2022-03
    16K→100,000人（6ヶ月）  :2022-03, 2022-08
    100K→250,000人（売却時）:2022-08, 2022-12
```
...
```mermaid
flowchart LR
    A[スポンサー収入] -->|再投資| B[Facebook/TikTok広告]
    B -->|獲得| C[新規購読者]
    C -->|増加| D[広告インベントリ]
    D -->|販売| A
```
